...
const getCards = (stage: TransitionStageT): MBCardT[] => {
  ...
  return [
    ...
    {
      xPct: 25, top: MY_S, isBlue: !isSemi,
      icon: isSemi ? 'question' : 'shirt',
      fadeDelay: '0.2s', isArriving: isSemi, arriveDelay: '1s',
    },
    {
      xPct: 75, top: MY_S, isBlue: !isSemi,
      icon: isSemi ? 'question' : 'cap',
      fadeDelay: '0.25s', isArriving: isSemi, arriveDelay: '1.05s',
    },
    {
...
const getPaths = (stage: TransitionStageT): ConnPathT[] => {
  const isSemi = stage === 'toSemi';
  const Q1 = 0.125 * MB_W, Q2 = 0.375 * MB_W, Q3 = 0.625 * MB_W, Q4 = 0.875 * MB_W;
  ...
  if (icon === 'bag') {
    return (
      <svg width={35} height={35} viewBox="0 0 39 39" fill="none" aria-hidden>
        <path d="M18.7486 0.0172443C23.3845 -0.238971 27.661 2.37214 28.798 7.03474C28.9572 7.68781 29.0328 8.28583 29.0951 8.95512C34.9301 10.3975 35.857 15.1896 37.241 20.2722C38.0901 23.3905 38.7015 25.8244 38.8151 29.0657C39.0088 34.5934 35.8582 37.253 30.6634 38.1208C27.0317 38.7563 23.7183 38.7803 20.0326 38.8177C15.519 38.845 7.77461 38.8653 3.84618 36.7035C2.11656 35.7516 0.940772 34.3255 0.393074 32.424C-0.037456 30.9292 -0.0576217 29.3239 0.0654388 27.7842C0.262238 25.3223 0.886804 22.9591 1.50053 20.577C2.13105 18.1299 2.75904 15.4629 3.98862 13.2452C5.31519 10.8526 7.15056 9.69205 9.73674 8.9509C9.97239 3.83325 13.7624 0.420809 18.7486 0.0172443Z" fill="currentColor" />
        <path d="M11.2237 14.5638C11.473 14.5403 11.9274 14.5512 12.1835 14.5512L26.535 14.5518C27.1563 14.552 27.8834 14.4719 28.4149 14.8382C28.7705 15.0855 29.0132 15.4645 29.0885 15.8912C29.1617 16.314 29.0648 16.7487 28.8185 17.1C28.5288 17.5093 28.1498 17.6914 27.6708 17.775C26.7667 17.8288 25.5106 17.7899 24.5791 17.7897L13.802 17.7898C12.9648 17.7898 12.0952 17.8029 11.2597 17.7722C10.8898 17.7586 10.6536 17.6875 10.3571 17.4628C10.0042 17.1978 9.77353 16.8014 9.71759 16.3636C9.59732 15.3879 10.2807 14.678 11.2237 14.5638Z" fill="#F4F4F6" />
        <path d="M19.18 3.23781C20.5724 3.15613 22.213 3.60353 23.3479 4.41199C24.7401 5.40359 25.4742 6.7062 25.7706 8.35673C23.6003 8.16527 21.8233 8.09909 19.6379 8.08569C17.4385 8.06033 15.2393 8.15042 13.0493 8.35555C13.5887 5.14786 16.0435 3.40095 19.18 3.23781Z" fill="#F4F4F6" />
      </svg>
    );
  }
  if (icon === 'question') {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Content */}
        <div className="relative flex flex-col items-center px-5 pb-5 pt-[31px]">
          {/* Countdown timer */}
          <div
          ...
          >
            ...
            <span
              className="text-[20px] font-bold leading-7 tracking-[-0.6px]"
              style={{ color: '#1F7AF9' }}
            >
              {remaining}
            </span>
          ...
          <div className="mt-[10px] flex flex-col items-center gap-1">
            <h2 className="text-[20px] font-bold leading-7 tracking-[-0.6px] text-text-neutral-primary">
              {title}
            </h2>
            <p className="text-[16px] font-semibold leading-[22px] tracking-[-0.6px]">
              {isSemi ? (
                <>
