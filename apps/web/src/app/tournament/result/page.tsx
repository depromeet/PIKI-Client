...
function TournamentResultPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col justify-between bg-[#eef1f3] px-[22px] pt-[67px] pb-[28px]">
      <section>
      ...
      <section className="mx-auto flex w-full max-w-[420px] flex-1 flex-col items-center justify-center pt-[24px] pb-[20px]">
        <div className="relative isolate w-full" ref={animationScopeRef}>
          ...
          <div className="pointer-events-none absolute top-[34px] left-1/2 z-40 h-[530px] w-[78%] -translate-x-1/2 overflow-hidden">
            <div
            ...
            >
                ...
                {receiptItems.map(receiptItem => (
                  <div className="flex items-center justify-between" key={receiptItem.name}>
                    <div>
                      ...
                      <p className="text-[10px] leading-[13px] font-bold text-[#2f3338]">
                        DISCOUNT: 1/2 PRICE
                      </p>
                    </div>
              ...
              <div className="pt-[12px] text-center">
                ...
                <p className="mt-[4px] text-[14px] leading-[18px] font-bold text-[#2f3338]">
                  YOU SAVED £100!
                </p>
